...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Dengan sayang" },
      ...
      { name: "twitter:title", content: "Ayo Ngedate! • 3–4 Oktober di Bekasi" },
      {
        name: "twitter:description",
        content: "Undangan date 2 hari 1 malam di Bekasi, 3–4 Oktober. Aku ikut?",
      },
    ],
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Gochi+Hand&family=Plus+Jakarta+Sans:wght@400;500;600;700&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
